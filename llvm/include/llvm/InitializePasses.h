...
/// Initialize all passes linked into the SymbolicCompiler library.
void initializeSymbolicCompiler(PassRegistry&);
...
void initializeSymbolizePassPass(PassRegistry&);
